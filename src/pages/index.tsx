            ...
            <div className="grid grid-cols-12 gap-4 ml-80 mt-10 max-w-4xl">
                ...
                <div className="col-span-4 max-w-xs p-6 text-center bg-white border border-gray-200 rounded-lg shadow-md">
                    ...
                    {statsIsLoading ? (
                        <svg
                            aria-hidden="true"
                            className="m-auto mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                            viewBox="0 0 100 101"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                        ...
                        <h2 className="mb-2 text-5xl py-2 font-semibold tracking-tight text-gray-900">
                            {stats.totalDevice}
                        </h2>
                    )}
                ...
                <div className="col-span-4 max-w-xs p-6 text-center bg-white border border-gray-200 rounded-lg shadow-md">
                    <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="m-auto w-8 h-8 m-auto"
                    >
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
